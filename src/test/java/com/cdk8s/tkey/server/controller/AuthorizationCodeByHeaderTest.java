...
/**
 * 把 CLIENT_SECRET 和 CLIENT_SECRET 使用 Header Authorization 参数方式提交
 */
@FixMethodOrder(MethodSorters.NAME_ASCENDING)
@RunWith(SpringRunner.class)
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@AutoConfigureMockMvc
public class AuthorizationCodeByHeaderTest {

	private static final Charset UTF8_CHARSET = StandardCharsets.UTF_8;

	private static final MediaType JSON_MEDIA_TYPE = new MediaType(MediaType.APPLICATION_JSON.getType(), MediaType.APPLICATION_JSON.getSubtype(), UTF8_CHARSET);
	...
	public void c_token() {
		RequestBuilder request = MockMvcRequestBuilders
				...
				.header("Authorization", GlobalVariableToJunit.HTTP_HEADER_BASIC_AUTHORIZATION)
				.param("grant_type", GlobalVariableToJunit.CODE_GRANT_TYPE)
				.param("client_id", GlobalVariableToJunit.CLIENT_ID)
				.param("redirect_uri", REDIRECT_URI)
				.param("code", GlobalVariableToJunit.CODE2)
